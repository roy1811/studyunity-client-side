...
const ResearchArea = () => {
   const researchData = [
      {
         ...
         title: <h4>Expert Guidance <br /> Counselling by Experts </h4>,
         bg_class: ''
      },
      {
         id: 2,
         ...
         title: <h4>Admission <br /> All the process</h4>,
         bg_class: 'yellow-bg',
      },
      {
         id: 3,
   ...
   return (
      <>
         <section className="research__area pb-160">
            <div className="container">
               <div className="row">
                  <div className="col-xxl-6 col-xl-6 col-lg-6">
                     <div className="research__wrapper-2">
                        <div className="section__title-wrapper-2">
                           <span className="section__title-pre-2">Pursue Your Dream</span>
                           <h3 className="section__title-2">More then just consultancy</h3>
                        </div>
                        <p>A Reliable Education Consultant for Engineering, Medical, Management, and Job-Oriented Courses in India and Abroad.</p>
