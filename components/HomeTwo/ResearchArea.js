...
const ResearchArea = () => {
  ...
  return (
    <>
      <section className="research__area pb-60">
              ...
              <div className="research__wrapper-2">
                <div className="section__title-wrapper-2">
                  ...
                  <h3 className="section__title-2">
                    More then just consultancy
                  </h3>
                </div>
                <p>
                  A Reliable Education Consultant for Engineering, Medical,
                  Management, and Job-Oriented Courses in India and Abroad.
                </p>
                ...
                <div className="research__download">
                  <div
                    ...
                    data-background="assets/img/research/2/research-bg.jpg"
                  ></div>
              ...
              <div className="research__features-wrapper pt-35">
                {researchData.map((research) => {
                  return (
                    <div
                      key={research.id}
                      className="research__features-item d-sm-flex align-items-start mb-40"
                    >
