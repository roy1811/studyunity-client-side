                  ...
                  <div className="footer__widget footer__widget-2 footer-col-2-1 mb-50">
                    ...
                    <div className="footer__widget-content">
                      <div className="footer__widget-info">
                        <p>
                        Chase Your Aspirations with Us - Beyond Consultancy. Your Trusted Education Consultant for Engineering,
                         Medical, Management, and Job-Oriented Courses in India and Abroad.
                        </p>
