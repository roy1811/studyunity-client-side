   ...
   const featuresData = [
      {
         ...
         title: 'MBBS Abroad',
         discription: 'Pursue MBBS Abroad with Expert Guidance!',
      },
      {
         id: 2,
         ...
         title: 'MBBS India',
         discription: 'Your Path to MBBS in India Starts Here!',
      },
      {
         id: 3,
         ...
         discription: 'Explore Management and Engineering Studies in India!',
      },
   ]
   return (
      <>
