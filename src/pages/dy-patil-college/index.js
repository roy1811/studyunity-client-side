...
import BreadCrumb from "../../../components/CourseDetailsDyPatil/BreadCrumb";
import Footer from "../../../components/common/Footer";
import CourseDetailsArea from "../../../components/CourseDetailsDyPatil/CourseDetailsArea";
import Header from "../../../components/Home/Header";
import SEO from "../../../components/seo";
import { useGetCourseQuery } from "../../../redux/api/apiSlice";
import DetailsTabItems from "../../../components/CourseDetailsDyPatil/DetailsTabItems";

const DyPatilCollege = () => {
  const {
    data: course,
    isLoading,
    isError,
